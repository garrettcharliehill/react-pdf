<p align="center">
  ...
  <p align="center">
    <a href="https://www.npmjs.com/package/@garrettcharliehill/react-pdf-renderer">
      <img src="https://img.shields.io/npm/v/@garrettcharliehill/react-pdf-renderer.svg" />
    </a>
...
## How to install
```sh
yarn add @garrettcharliehill/react-pdf-renderer
```
...
import { Document, Page, Text, View, StyleSheet } from '@garrettcharliehill/react-pdf-renderer';
...
import { PDFViewer } from '@garrettcharliehill/react-pdf-renderer';
...
```jsx
import React from 'react';
import ReactPDF from '@garrettcharliehill/react-pdf-renderer';
...
---
![](https://img.shields.io/npm/dt/@garrettcharliehill/react-pdf-renderer.svg?style=flat)
